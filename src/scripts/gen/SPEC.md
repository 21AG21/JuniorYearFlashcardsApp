...
### Counts
- Ordinary cards: 80 to 140 for the unit, 10 to 16 per topic (a topic with little essential knowledge may carry 6). Cover EVERY question type the EK statements support, topic by topic, not a sample.
